...
def elitsm(pop_num,chromo2):
    ...
    for pop in chromo_temp:
        if pop.pareto_rank == current_rank:
            current_ind[current_rank] = current_ind[current_rank] + 1
...
if __name__ == "__main__":
    pop = [Pop(pop_index, x_min, x_max, x_num, f_num, fun_name) for (pop_index, x_min, x_max, x_num, f_num, fun_name) in [(1, 1, 1, 1, 1, 'ZDT1'),(2, 1, 1, 1, 1, 'ZDT1')]]
    for i in pop:
        print(i.index())